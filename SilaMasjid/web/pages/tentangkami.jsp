<%-- 
    ...
    Created on : Dec 31, 2011, 4:23:44 AM
    Author     : yooganz
--%>
...
<html>
    ...
    <tr> 
        <td class="mctop"><table width="94%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><img src="file:///E|/contoh_laporan.gif" width="500" height="250" longdesc="file:///E|/contoh_laporan.gif">
              ...
              <tr>
                ...
                <td width="4%">&nbsp;</td>
                <td width="1%">&nbsp;</td>
                <td colspan="4"><b>SEKILAS MENGENAI SILA-MASJID:<b></b></b></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td colspan="4">&nbsp;</td>
                <td width="39%" colspan="2"><blockquote>
                  <p>&nbsp;</p>
                </blockquote></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td colspan="7">SILA-MASJID merupakan sebuah web yang dikembangkan oleh mahasiswa Jurusan Sistem Informasi Institut Teknologi Sepuluh Nopember (SI-ITS) Surabaya yang bertujuan untuk mengakomodasi kebutuhan akuntansi bagi masjid sebagai sarana dalam menerapkan Akuntansi Sektor Publik yang dicanangkan oleh Pemerintah RI. dalam web ini terdapat beberapa fungsi antara lain :</td>
                </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>3. Input Penerima Dana Masjid</td>
                <td>&nbsp;</td>
                </tr>
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>1. Laporan Saldo Dana Masjid</td>
                <td>&nbsp;</td>
                <td colspan="3" rowspan="8" align="left"><img src="images/lap_pengeluaran.gif" width="315" height="147"></td>
                </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>2. Laporan Penerimaan Masjid</td>
                <td>&nbsp;</td>
                </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>3. Laporan Pengeluaran Masjid</td>
                <td>&nbsp;</td>
                </tr>
              <tr>
                <td>&nbsp;</td>
