...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mcbg"> 
    <tr> 
<%--JUDUL DI SINI--%>
        <td width="700" height="32" class="contentheader"><div align="center"><b>TULIS BERITA</b></div></td>
    </tr>
    <tr> 
 ...
 <%--ISI MULAI DI SINI--%>
                <form action="unggahberita" method="post" >

                    <tr>
                        <td width="10%">&nbsp;</td>
                        <td>Judul</td><td><input type="text" name="judul" style="width: 160px"></td>
                    </tr>
                    <tr>
                        <td width="10%">&nbsp;</td>
